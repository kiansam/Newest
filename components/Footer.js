...
const Footer = () => {
  return (
    <footer className="">
        <div className="grid grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-gray-100 dark:border-trueGray-700">
          {/* <footer className="text-gray-600 w-full body-font mb-0 items-center align-middle"> */}
            ...
            <div className="bg-gray-100">
              <div className="container mx-auto px-5 flex flex-wrap flex-col sm:flex-row py-10">
                ...
                <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start space-x-4 md:space-x-6">
                  ...
                  <Link
                    href="https://www.instagram.com/kiansmdn/"
                    className="ml-3 text-gray-500 hover:text-purple-500"
                    target="_blank"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Link
                    href="https://www.linkedin.com/in/kiansamadani/"
